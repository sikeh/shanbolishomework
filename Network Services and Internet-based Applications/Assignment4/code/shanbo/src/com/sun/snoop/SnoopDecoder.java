  ...
  public static long byteArrayToLong(byte[] byteArray, int startPos, int length)
  {
    ...
    switch (length)
    {
      ...
      case 4:   value |= ((0x000000FF & byteArray[startPos]) << 24) |
                         ...
                         (0x000000FF & byteArray[startPos+3]);
                break;
      case 5:   value |= ((0x000000FF & byteArray[startPos]) << 32) |
                ...
                break;
      case 6:   value |= ((0x000000FF & byteArray[startPos]) << 40) |
                ...
                break;
      case 7:   value |= ((0x000000FF & byteArray[startPos]) << 48) |
                ...
                break;
      case 8:   value |= ((0x000000FF & byteArray[startPos]) << 56) |
