    ...
    public static int byteArrayToInt(byte[] byteArray, int startPos, int length) {
        ...
        switch (length) {
            case 1:
                ...
                break;
            case 2:
                value |= ((0x000000FF & byteArray[startPos]) << 8) |
                        (0x000000FF & byteArray[startPos + 1]);
                break;
            case 3:
                value |= ((0x000000FF & byteArray[startPos]) << 16) |
                        ((0x000000FF & byteArray[startPos + 1]) << 8) |
                        (0x000000FF & byteArray[startPos + 2]);
                break;
            case 4:
                value |= ((0x000000FF & byteArray[startPos]) << 24) |
    ...
    public static long byteArrayToLong(byte[] byteArray, int startPos, int length) {
        ...
        switch (length) {
            ...
            case 4:
                ...
                break;
            case 5:
                value |= ((0x000000FF & byteArray[startPos]) << 32) |
                        ((0x000000FF & byteArray[startPos + 1]) << 24) |
                        ((0x000000FF & byteArray[startPos + 2]) << 16) |
                        ((0x000000FF & byteArray[startPos + 3]) << 8) |
                        (0x000000FF & byteArray[startPos + 4]);
                break;
            case 6:
                value |= ((0x000000FF & byteArray[startPos]) << 40) |
                        ((0x000000FF & byteArray[startPos + 1]) << 32) |
                        ((0x000000FF & byteArray[startPos + 2]) << 24) |
                        ((0x000000FF & byteArray[startPos + 3]) << 16) |
                        ((0x000000FF & byteArray[startPos + 4]) << 8) |
                        (0x000000FF & byteArray[startPos + 5]);
                break;
            case 7:
                value |= ((0x000000FF & byteArray[startPos]) << 48) |
                        ((0x000000FF & byteArray[startPos + 1]) << 40) |
                        ((0x000000FF & byteArray[startPos + 2]) << 32) |
                        ((0x000000FF & byteArray[startPos + 3]) << 24) |
                        ((0x000000FF & byteArray[startPos + 4]) << 16) |
                        ((0x000000FF & byteArray[startPos + 5]) << 8) |
                        (0x000000FF & byteArray[startPos + 6]);
                break;
            case 8:
                value |= ((0x000000FF & byteArray[startPos]) << 56) |
                        ((0x000000FF & byteArray[startPos + 1]) << 48) |
                        ((0x000000FF & byteArray[startPos + 2]) << 40) |
                        ((0x000000FF & byteArray[startPos + 3]) << 32) |
                        ((0x000000FF & byteArray[startPos + 4]) << 24) |
                        ((0x000000FF & byteArray[startPos + 5]) << 16) |
                        ((0x000000FF & byteArray[startPos + 6]) << 8) |
                        (0x000000FF & byteArray[startPos + 7]);
                break;
        }
