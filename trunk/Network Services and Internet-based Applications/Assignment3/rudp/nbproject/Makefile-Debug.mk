...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Debug/GNU-Linux-x86/rudp

dist/Debug/GNU-Linux-x86/rudp: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${LINK.c} -o dist/Debug/GNU-Linux-x86/rudp ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/rudp
